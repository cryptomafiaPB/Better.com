...
export default function Footer() {
  return (
    ...
    //       <div>
    //         <h3 className="font-bold mb-4">Better</h3>
    //         <p className="text-sm text-gray-600">
    //           A family of companies serving all your homeownership needs
    //         </p>
    //       </div>
    //       <div>
      ...
      <div className="m-auto px-6 py-6 md:px-10 lg:px-16 xl:px-20 2xl:px-40">
            ...
            <ul className="mt-2 space-y-4 md:mt-6">
              <li>
                <Link
                  ...
                  className="hover-gradient-effect block py-1 text-stone-800 hover:underline"
                >
              ...
              <li>
                <Link
                  className="hover-gradient-effect block py-1 text-stone-500  hover:underline"
        ...
        <div className="mt-12">
          <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs">
            ...
            <Link
              className="font-normal underline focus:outline-interactivePrimary focus:outline-1 focus:outline-offset- hover:text-interactivePrimary text-inherit"
          ...
          <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-3">
            <sup>2</sup>Better Mortgage One Day HELOC™ promotion offers
            qualified customers who provide certain required financial
            information/documentation to Better Mortgage within 4 hours of
          ...
          <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-4">
            ...
            full listing of Better Cover, LLCs{" "}
            <Link
              className="underline"
