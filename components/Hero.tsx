...
export default function HeroSection() {
  ...
  return (
    <>
      <section className="section bg-[rgb(0_71_51)]">
        <div className="m-auto max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
          <h1 className="font-medium leading-[3.5rem] m-0 p-0 w-auto tracking-tight md:tracking-tighter top-32 z-[1] pt-12 leadin text-center text-[50px] text-[rgb(30_224_127)] md:relative md:top-[72px] lg:top-32 md:p-0 md:leading-none md:text-4xl lg:text-[118px]">
            Mortgages
            <br />
            made simple
          </h1>
          <div className="relative flex flex-col items-center justify-center md:flex-row">
            <div className="w-80 md:w-auto">
              <a
                className="inline-flex py-5 items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 bg-[rgb(30_224_127)] text-[rgb(41_43_41)] hover:bg-[rgb(0_71_51)] hover:text-[#DFE0DC] h-16 px-12  mt-6 w-full md:mt-none md:w-fit"
                href="/start"
              >
                Start my approval
              </a>
              <div className="mt-3 flex items-center justify-center gap-1 text-sm text-[#DFE0DC]">
                <svg
                  fill="#DFE0DC"
                  width="20px"
                  height="20px"
            ...
            <div className="rounded-lg absolute bottom-8 bg-[#073126] px-3 py-2.5 md:relative md:bg-transparent md:mt-lg">
              ...
              <div className="mt-1 text-xs text-[#DFE0DC]">Google reviews</div>
            </div>
          </div>
        </div>
      </section>
